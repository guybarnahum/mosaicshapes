...
class TestTriangleCell(unittest.TestCase):
    ...
    def test_avg_lum(self):
        triangle = TriangleCell(size=(200,200), base_colors=[], 
            second_colors=[], shrink=0, quadrant=Quadrant.top_right)
    ...
    def test_find_best(self):
        ...
        base_colors = GenColor.gen_colors((200,0,0), n=4,colorful=True)
        second_colors = GenColor.gen_colors((100,200,200), n=1,colorful=True)
        ...
        trect,_ = TriangleCell.find_best(cropped, base_colors, second_colors)
    ...
    def test_draw(self):
        base_colors = GenColor.gen_colors((200,0,0), n=4,colorful=True)
        second_colors = GenColor.gen_colors((100,200,200), n=1,colorful=True)
        triangle = TriangleCell(size=(100,100), base_colors=base_colors, 
            second_colors=second_colors, quadrant=Quadrant.bottom_left)
